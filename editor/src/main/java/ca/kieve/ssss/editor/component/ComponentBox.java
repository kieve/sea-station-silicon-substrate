...
public class ComponentBox extends VBox {
    private static final String STYLE_COMPONENT_BOX = "editor-component-box";
    private static final String STYLE_COMPONENT_TYPE = "editor-component-type";
    private static final String STYLE_COMPONENT_MARKER = "editor-component-marker";
    ...
    private static final String CSS = """
        ...
        """.formatted(STYLE_COMPONENT_BOX, STYLE_COMPONENT_TYPE, STYLE_COMPONENT_MARKER);
    ...
    public ComponentBox(ComponentDefinition comp) {
        ...
        for (var entry : props.entrySet()) {
            getChildren().add(new EditorLabel(entry.getKey() + ": " + entry.getValue()));
        }
    }
}
