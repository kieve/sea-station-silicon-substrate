...
public class StartupHelper {
     ...
     *                       it can be accessed in the same place; keeps the old JVM running if
     *                       enabled
    ...
    public static boolean startNewJvmIfRequired(boolean redirectOutput) {
        ...
        if (!osName.contains("mac")) {
            if (osName.contains("windows")) {
                ...
                // We also temporarily change the "user.name" property to one without any chars that
                // would be invalid.
        ...
        String javaExecPath = System.getProperty("java.home") + separator + "bin" + separator
            + "java";
